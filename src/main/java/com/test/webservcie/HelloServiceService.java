 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://webservcie.test.com", wsdlLocation = "http://127.0.0.1:6789/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://webservcie.test.com", "HelloServiceService");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://webservcie.test.com", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservcie.test.com", "HelloServicePort"), HelloService.class, features);
    }
